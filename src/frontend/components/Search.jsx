...
const Search = (props) => {
    ...
    const handleResetData = () => {
        ...
        const searchData = async () =>{
            ...
            value
            ? props.putSeachData(res.results)
            : props.putSeachData([])
